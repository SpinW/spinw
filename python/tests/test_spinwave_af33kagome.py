...
class AF33kagomeTest(unittest.TestCase):
    ...
    def test_spinwave_calc(self):
        ...
        kag33spec = m.sw_egrid(kag33spec,'component','Sxx+Syy','imagChk',False, 'Evect', np.linspace(0, 3, 100).tolist())  # if not .tolist() then Evect has 501 edges!
        ...
        # validate
        mat = scipy.io.loadmat('../../test_data/system_tests/systemstest_spinwave_af33kagome.mat')
